...
public class QRCodeUtil {
    ...
    private static Bitmap addLogo(Bitmap src, Bitmap logo) {
        ...
        int logoWidth = logo.getWidth()+6;
        int logoHeight = logo.getHeight()+6;
...
//        logo = BitmapUtil.getRoundedCornerBitmap(logo,15);
        try {
            ...
            float left = (srcWidth - logoWidth) / 2;
            float top =  (srcHeight - logoHeight) / 2;
            RectF targetRect = new RectF(left, top, left + logoWidth, top + logoHeight);
            canvas.drawRoundRect(targetRect,15,15,paint);

            canvas.drawBitmap(logo, (srcWidth - logo.getWidth()) / 2, (srcHeight - logo.getHeight()) / 2, null);
