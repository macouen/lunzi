...
package com.oakzmm.demoapp.zxing.camera;
...
public final class CameraManager {
    ...
    private CameraManager(Context context) {
        ...
        MIN_FRAME_HEIGHT = DensityUtil.dip2px(context, MIN_FRAME_HEIGHT);
        MAX_FRAME_WIDTH = DensityUtil.dip2px(context, MAX_FRAME_WIDTH);
        MAX_FRAME_HEIGHT = DensityUtil.dip2px(context, MAX_FRAME_HEIGHT);
